...
# RNA_d74 <- readRDS("250829_retina_chromatin_d74_RNAseq_No3.rds")
multiome_d74 <- readRDS("250829_retina_chromatin_d74_ATACseq_No3.rds")
...
peaks <- granges(multiome_d74[["peaks"]])

gene_anno <- Annotation(multiome_d74)
...
# write.csv(peaks_in_region_NOTCH1, "ATAC_peaks_NOTCH1_d74.csv")
result_NOTCH1 <- read.csv("ATAC_peaks_NOTCH1_d74.csv")
result_NOTCH1
...
# write.csv(peaks_in_target_region_NOTCH1, "ATAC_peaks_NOTCH1_roi_d74.csv")
result_NOTCH1_roi <- read.csv("ATAC_peaks_NOTCH1_roi_d74.csv")
result_NOTCH1_roi
...
# write.csv(peaks_in_region_NOTCH3, "ATAC_peaks_NOTCH3_d74.csv")
result_NOTCH3 <- read.csv("ATAC_peaks_NOTCH3_d74.csv")
result_NOTCH3

target_region_NOTCH3 <- GRanges(seqnames = "chr19",
                                ranges = IRanges(start = 15160000, end = 15210000))
peaks_in_target_region_NOTCH3 <- subsetByOverlaps(peaks, target_region_NOTCH3)
peaks_in_target_region_NOTCH3
# write.csv(peaks_in_target_region_NOTCH3, "ATAC_peaks_NOTCH3_roi_d74.csv")
result_NOTCH3_roi <- read.csv("ATAC_peaks_NOTCH3_roi_d74.csv")
result_NOTCH3_roi
