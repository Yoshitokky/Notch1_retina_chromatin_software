...
# RNA_d78 <- readRDS("250829_retina_chromatin_d78_RNAseq_No3.rds")
multiome_d78 <- readRDS("250829_retina_chromatin_d78_ATACseq_No3.rds")
...
peaks <- granges(multiome_d78[["peaks"]])

gene_anno <- Annotation(multiome_d78)
...
# write.csv(peaks_in_region_NOTCH1, "ATAC_peaks_NOTCH1_d78.csv")
result_NOTCH1 <- read.csv("ATAC_peaks_NOTCH1_d78.csv")
result_NOTCH1
...
# write.csv(peaks_in_target_region_NOTCH1, "ATAC_peaks_NOTCH1_roi_d78.csv")
result_NOTCH1_roi <- read.csv("ATAC_peaks_NOTCH1_roi_d78.csv")
result_NOTCH1_roi
...
# write.csv(peaks_in_region_NOTCH3, "ATAC_peaks_NOTCH3_d78.csv")
result_NOTCH3 <- read.csv("ATAC_peaks_NOTCH3_d78.csv")
result_NOTCH3

target_region_NOTCH3 <- GRanges(seqnames = "chr19",
                                ranges = IRanges(start = 15100000, end = 15252000))
peaks_in_target_region_NOTCH3 <- subsetByOverlaps(peaks, target_region_NOTCH3)
peaks_in_target_region_NOTCH3
# write.csv(peaks_in_target_region_NOTCH3, "ATAC_peaks_NOTCH3_roi_d78.csv")
result_NOTCH3_roi <- read.csv("ATAC_peaks_NOTCH3_roi_d78.csv")
result_NOTCH3_roi
...
# [7] patchwork_1.3.1           ggplot2_3.5.2             GenomicRanges_1.56.2     
# [10] GenomeInfoDb_1.40.1       IRanges_2.38.1            S4Vectors_0.42.1         
# [13] BiocGenerics_0.50.0       Seurat_5.3.0              SeuratObject_5.1.0       
# [16] sp_2.2-0                  Signac_1.14.0            
# 
...
# [115] crayon_1.5.3                future.apply_1.20.0         labeling_0.4.3             
# [118] plyr_1.8.9                  stringi_1.8.7               viridisLite_0.4.2          
# [121] deldir_2.0-4                BiocParallel_1.38.0         Biostrings_2.72.1          
# [124] lazyeval_0.2.2              spatstat.geom_3.4-1         Matrix_1.6-5               
# [127] RcppHNSW_0.6.0              bit64_4.6.0-1               future_1.58.0              
# [130] KEGGREST_1.44.1             shiny_1.11.1                SummarizedExperiment_1.34.0
# [133] ROCR_1.0-11                 igraph_2.1.4                memoise_2.0.1              
# [136] fastmatch_1.1-6             bit_4.6.0 